...
function init() {
  ...
  if (typeof projectName === 'undefined') {
    ...
    console.log(
      `  ${chalk.cyan(program.name())} ${chalk.green('my-notethru-component')}`
    );
    console.log();
    console.log(
  ...
  checkForLatestVersion()
    .catch(() => {
      try {
        return execSync('npm view create-notethru-component version').toString().trim();
      } catch (e) {
        return null;
      }
    })
    .then(latest => {
      if (latest && semver.lt(packageJson.version, latest)) {
        ...
        console.error(
          chalk.yellow(
            `You are running \`create-notethru-component\` ${packageJson.version}, which is behind the latest release (${latest}).\n\n` +
              'We recommend always using the latest version of create-react-app if possible.'
          )
        );
        console.log();
        console.log(
          'The latest instructions for creating a new component can be found here:\n' +
            //TODO: To modify it to a right url
...
function getInstallPackage(version, originalDirectory) {
  ...
  //       `The react-scripts-ts package is deprecated. TypeScript is now supported natively in Create Notethru Component. You can use the ${chalk.green(
  //         '--template typescript'
    ...
    console.error(
      chalk.red(
        'You are running Node %s.\n' +
          'Create Notethru Component requires Node %s or higher. \n' +
